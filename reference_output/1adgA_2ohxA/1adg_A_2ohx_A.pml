...
reinitialize
load 1adg_A_2ohx_A.pdb
bg_color grey
color grey

# === HIERARCHICAL DOMAIN STRUCTURE COLORING ===
select domain_0, resi 1-171
select domain_0, domain_0 + resi 317-368
color blue, domain_0  # Domain 0 (GLOBAL REFERENCE)

select domain_1, resi 175-282
select domain_1, domain_1 + resi 296-311
color yellow, domain_1  # Domain 1 (MOVING)

# Color bending residues
select bending_residues_1, resi 172-174
color green, bending_residues_1
select bending_residues_2, resi 283-295
...
hide everything, 1adg_A_2ohx_A_arrows
